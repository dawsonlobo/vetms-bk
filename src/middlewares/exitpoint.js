...
var exitPoint = function (req, res) {
  ...
  var authorizationHeader =
    (_b = req.headers.authorization) !== null && _b !== void 0 ? _b : "";
  ...
  if (parts.length === 2 && parts[0].toLowerCase() === "bearer") {
    ...
    logger_1.default === null || logger_1.default === void 0
      ? void 0
  ...
  reqData.response =
    (_c = req === null || req === void 0 ? void 0 : req.apiStatus) === null ||
    _c === void 0
      ? void 0
      : _c.data;
  ...
  if ((_d = req.apiStatus) === null || _d === void 0 ? void 0 : _d.data) {
    if (
      (_e = req === null || req === void 0 ? void 0 : req.apiStatus) === null ||
      _e === void 0
        ? void 0
        : _e.isSuccess
    ) {
      var responseObj = new models_1.ResponseObj(
        200,
        "Success",
        req.apiStatus.data,
      ...
      var responseObj = new models_1.ResponseObj(
        (_h =
          (_g =
            (_f = req.apiStatus) === null || _f === void 0
              ? void 0
              : _f.error) === null || _g === void 0
            ? void 0
            : _g.statusCode) !== null && _h !== void 0
          ? _h
          : 500,
        (_l =
          (_k =
            (_j = req.apiStatus) === null || _j === void 0
              ? void 0
              : _j.error) === null || _k === void 0
            ? void 0
            : _k.message) !== null && _l !== void 0
          ? _l
          : "Unknown error",
        (_m = req.apiStatus) === null || _m === void 0 ? void 0 : _m.data,
        (_o = req.apiStatus) === null || _o === void 0
          ? void 0
          : _o.toastMessage,
      );
      res.status(responseObj.status).json(responseObj);
