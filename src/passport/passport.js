...
var ACCESS_SECRET = config_1.config.JWT_SECRET || "access_secret";
passport_1.default.use(new passport_http_bearer_1.Strategy(function (token, done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, users_1.default.findById(decoded.id).lean()];
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, done(null, false, { message: "User not found", scope: "error" })];
                }
