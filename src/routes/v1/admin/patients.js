...
var patients_1 = require("../../../controllers/v1/admin/patients");
 ...
 *                         updatedAt: "2025-02-01T08:00:00Z"
 */
router.post("/getAll", entrypoint_1.entryPoint, passport_1.default.authenticate("bearer", { session: false }), auth_1.verifyAdmin, patients_1.getAll, exitpoint_1.exitPoint);
/**
 * @swagger
 ...
 *                     updatedAt: "2025-02-01T08:00:00Z"
 */
router.post("/getOne/:id", entrypoint_1.entryPoint, passport_1.default.authenticate("bearer", { session: false }), auth_1.verifyAdmin, patients_1.getOne, exitpoint_1.exitPoint);
