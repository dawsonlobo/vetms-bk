...
import doctorDashBoard from "../src/routes/v1/doctor/dashboard"
import adminDashBoard from "../src/routes/v1/admin/dashboard"
...
app.use("/v1/doctor/dashboard", doctorDashBoard);
...
app.use("/v1/admin/dashboard", adminDashBoard);
