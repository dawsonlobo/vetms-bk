...
var ACCESS_TOKEN_EXPIRY = config_1.config.ACCESS_TOKEN_EXPIRY,
  REFRESH_TOKEN_EXPIRY = config_1.config.REFRESH_TOKEN_EXPIRY;
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 2:
          ...
          if (
            !user ||
            (user === null || user === void 0 ? void 0 : user.isDeleted)
          ) {
            req.apiStatus = {
              isSuccess: false,
          ...
          if (
            (user === null || user === void 0 ? void 0 : user.isEnabled) ===
            false
          ) {
            req.apiStatus = {
              isSuccess: false,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          projection = lodash_1.default.omit(projection, [
            "isDeleted",
            "password",
          ]);
          user = req.user;
          ...
          return [
            4 /*yield*/,
            (_a = users_1.default.findById(user.id)) === null || _a === void 0
              ? void 0
              : _a.select("_id isDeleted isEnabled").lean(),
          ];
        case 1:
          doesExist = _b.sent();
          if (!doesExist) {
        ...
        case 3:
          error_4 = _b.sent();
          console.error(
            "Error fetching nurse profile: ".concat(
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            users_1.default.findByIdAndUpdate(user.id, updateData_1, {
              new: true,
              select: "-password",
            }),
          ];
        ...
        case 3:
          error_5 = _a.sent();
          console.error(
            "Error updating nurse profile: ".concat(
              error_5 instanceof Error
                ? error_5.message
                : JSON.stringify(error_5),
            ),
          );
          req.apiStatus = {
            isSuccess: false,
