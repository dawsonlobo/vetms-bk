...
var patients_1 = require("../../../models/patients"); // Import the patients model
...
var parseEpoch = function (epoch) {
    var dateObj = new Date(epoch); // Convert epoch to Date
...
var getAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, projection, _c, filter, _d, options, _e, search, date, fromDate, toDate, isoDate, _f, totalCount, tableData, formattedData, error_1;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(patients_1.PatientModel, filter, projection, options, search)];
            case 1:
                _f = _g.sent(), totalCount = _f.totalCount, tableData = _f.tableData;
                formattedData = tableData.map(function (item) { return (__assign(__assign({}, item), { date: item.date ? new Date(item.date).toISOString() : null })); });
                req.apiStatus = {
                    isSuccess: true,
                    message: "Success",
...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, projection, result, formattedResult, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                formattedResult = __assign(__assign({}, result.tableData[0]), { date: result.tableData[0].date
