...
var createUpdate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, nurseId, nurse, _a, _id, doctorId, patientId, date, status_1, parsedDate, validatedStatus, appointment, isUpdate, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = req.body, _id = _a._id, doctorId = _a.doctorId, patientId = _a.patientId, date = _a.date, status_1 = _a.status;
                ...
                return [4 /*yield*/, appointments_1.AppointmentModel.findOneAndUpdate({ _id: _id, nurseId: nurseId }, __assign(__assign(__assign({}, (doctorId && { doctorId: doctorId })), (parsedDate && { date: parsedDate })), { status: validatedStatus }), { new: true }).exec()];
            case 2:
                ...
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, new appointments_1.AppointmentModel({
                    doctorId: doctorId,
                    date: parsedDate,
            ...
            case 5:
                req.apiStatus = {
                    ...
                    data: isUpdate
                        ? __assign(__assign(__assign({ _id: appointment._id, createdAt: appointment.createdAt, updatedAt: appointment.updatedAt }, (doctorId && { doctorId: doctorId })), (parsedDate && { date: new Date(parsedDate).toISOString() })), (status_1 && { status: status_1 })) : {
                        _id: appointment._id,
...
function getAll(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _b, projection, _c, filter, _d, options, _e, search, date, fromDate, toDate, Projection, Filter, parseEpoch, isoDate, regex_1, sortBy, sortOrder, sortOptions, page, itemsPerPage, skip, _f, totalCount, tableData, formattedData, error_2;
        var _g;
        var _h, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    if (filter.doctorId && mongoose_1.default.isValidObjectId(filter.doctorId)) {
                        Filter.doctorId = new mongoose_1.default.Types.ObjectId(filter.doctorId);
                    }
                    ...
                    if (search.term && search.fields && Array.isArray(search.fields)) {
                        ...
                        Filter.$or = search.fields.map(function (field) {
                            var _a;
                            return (_a = {},
                                _a[field] = { $regex: regex_1 },
                                _a);
                        });
                    }
                    sortBy = ((_h = options.sortBy) === null || _h === void 0 ? void 0 : _h.length) > 0 ? options.sortBy[0] : "createdAt";
                    sortOrder = ((_j = options.sortDesc) === null || _j === void 0 ? void 0 : _j.length) > 0 && options.sortDesc[0] ? -1 : 1;
                    ...
                    return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, Filter, Projection, __assign(__assign({}, options), { sort: sortOptions, skip: skip, limit: itemsPerPage }))];
                case 1:
                    _f = _k.sent(), totalCount = _f.totalCount, tableData = _f.tableData;
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                Projection = __assign({}, projection);
                delete Projection.isDeleted;
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, {
            ...
            case 1:
                ...
                if (!((_b = result === null || result === void 0 ? void 0 : result.tableData) === null || _b === void 0 ? void 0 : _b.length)) {
                    req.apiStatus = {
                        isSuccess: false,
                ...
                req.apiStatus = {
                    ...
                    data: {
                        _id: appointment._id,
                        patientId: (_c = appointment.patientId) !== null && _c !== void 0 ? _c : appointment.petId, // Ensure correct field mapping
                        doctorId: appointment.doctorId,
                        date: appointment.date
                            ? new Date(appointment.date * 1000).toISOString()
                            : null, // Convert from epoch to ISO
                        status: (_d = appointment.status) !== null && _d !== void 0 ? _d : appointment.schedule, // Ensure correct mapping
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, appointments_1.AppointmentModel.findOneAndUpdate({ _id: id, nurseId: user._id }, // Ensure the appointment belongs to the logged-in nurse
