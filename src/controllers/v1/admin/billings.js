...
var upsertBilling = function (req, res, next) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            billings_1.BillingModel.findByIdAndUpdate(_id, billingData, {
              new: true,
            }).exec(),
          ];
        case 2:
          ...
          return [3 /*break*/, 5];
        case 3:
          return [4 /*yield*/, new billings_1.BillingModel(billingData).save()];
        case 4:
          newBilling = _b.sent();
          req.apiStatus = {
            isSuccess: true,
