...
var followUps_1 = require("../../../models/followUps");
        ...
        switch (_h.label) {
            case 0:
                ...
                lookups = ((_g = req.body) === null || _g === void 0 ? void 0 : _g.lookupRequired)
                    ...
                    : [];
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(followUps_1.FollowUp, filter, projection, options, search, date, fromDate, toDate, lookups)];
            case 1:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(followUps_1.FollowUp, { _id: objectId, isDeleted: false }, projection)];
            case 1:
            ...
            case 2:
                error_2 = _b.sent();
                console.error("Error fetching FollowUp record:", error_2);
                req.apiStatus = {
                    isSuccess: false,
