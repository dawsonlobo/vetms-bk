...
var getAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, projection, _c, filter, _d, options, _e, search, date, fromDate, toDate, lookups, _f, totalCount, tableData, error_1;
    var _g;
        ...
        switch (_h.label) {
            case 0:
                ...
                lookups = ((_g = req.body) === null || _g === void 0 ? void 0 : _g.lookupRequired)
                    ...
                    : [];
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, filter, projection, options, search, date, fromDate, toDate, lookups)];
            case 1:
...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, _b, projection, _c, lookupRequired, lookups, aggregationPipeline, tableData, error_2;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 2, , 3]);
                id = req.params.id;
                _a = req.body, _b = _a.projection, projection = _b === void 0 ? {} : _b, _c = _a.lookupRequired, lookupRequired = _c === void 0 ? false : _c;
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, {}, // No filter is needed for `getOne`, since we already match by ID
                    projection, {}, // Empty options
                    [], // No search is needed
                    undefined, // No date, fromDate, or toDate
                    undefined, undefined, aggregationPipeline)];
            case 1:
