...
exports.getOne = exports.getAll = exports.deleteUser = exports.updateUser = exports.createUser = void 0;
...
var createUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, password, role, existingUser, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, bcryptjs_1.default.hash(password, config_1.config.ROUNDS)];
            case 2:
...
var updateUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, name_2, email, updateFields, userExists, updatedUser, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                return [4 /*yield*/, users_1.default.findByIdAndUpdate(userId, updateFields, { new: true, runValidators: true }).select("-password -isDeleted")];
            case 2:
                updatedUser = _b.sent();
                if (!updatedUser) {
                    req.apiStatus = {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(users_1.default, filter, projection, options, search, date, fromDate, toDate)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(users_1.default, { _id: new mongoose_1.default.Types.ObjectId(id) }, projection)];
            case 1:
                result = _a.sent();
