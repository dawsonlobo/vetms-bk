...
var createInventory = function (req, res, next) {
...
var updateInventory = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id,
      _a,
      name_2,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            inventories_1.InventoryModel.findByIdAndUpdate(
              id,
              __assign(
                __assign(
                  __assign(
                    __assign(
                      __assign({}, name_2 && { name: name_2 }),
...
var deleteInventory = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
