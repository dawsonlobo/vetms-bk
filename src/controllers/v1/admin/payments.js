...
var payments_1 = require("../../../models/payments"); // Import the Payment model
...
var getAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, projection, _c, filter, _d, options, _e, search, date, fromDate, toDate, _f, totalCount, tableData, error_1;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(payments_1.PaymentModel, filter, projection, options, search, date, fromDate, toDate)];
            case 1:
...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, projection, objectId, tableData, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(payments_1.PaymentModel, { _id: objectId, isDeleted: false }, projection)];
            case 1:
            ...
            case 2:
                error_2 = _b.sent();
                console.error("Error fetching Payment record:", error_2);
                req.apiStatus = {
                    isSuccess: false,
                    error: models_1.ErrorCodes[1002],
                    toastMessage: "Something went wrong. Please try again.",
