...
exports.deleteAppointment = exports.getOne = exports.getAll = exports.createUpdate = void 0;
...
var createUpdate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, accessTokenRecord, receptionistId, _a, _id, doctorId, patientId, date, status_1, parsedDate, formattedDate, validatedStatus, appointment, isUpdate, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, accessTokens_1.AccessToken.findOne({ token: token }).exec()];
            case 1:
                ...
                validatedStatus = status_1 || constant_1.CONSTANTS.APPOINTMENT_STATUS.PENDING;
                appointment = void 0;
                isUpdate = Boolean(_id);
                if (!isUpdate) return [3 /*break*/, 3];
                return [4 /*yield*/, appointments_1.AppointmentModel.findOneAndUpdate({ _id: _id, receptionistId: receptionistId }, __assign(__assign(__assign({}, (doctorId && { doctorId: doctorId })), (parsedDate && { date: parsedDate })), { status: validatedStatus }), { new: true }).exec()];
            case 2:
...
var getAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, projection, _c, filter, _d, options, _e, search, date, fromDate, toDate, _f, totalCount, tableData, error_2;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, filter, projection, options, search, date, fromDate, toDate)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, { _id: new mongoose_1.default.Types.ObjectId(id) }, projection)];
            case 1:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, appointments_1.AppointmentModel.findByIdAndDelete(id).exec()];
            case 1:
                appointment = _a.sent();
                if (!appointment) {
                    req.apiStatus = {
