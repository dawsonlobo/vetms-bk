...
import {generateTokens,verifyRefreshToken,generateAccessToken} from "../../../passport/jwt";
...
export async function getAdminProfile(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
