...
export async function getAdminProfile(
  ...
  try {
    ...
    console.error(
      `Error fetching admin profile: ${error instanceof Error ? error.message : JSON.stringify(error)}`,
    );
...
export async function updateAdminProfile(
  ...
  try {
    ...
    console.error(
      `Error updating admin profile: ${error instanceof Error ? error.message : JSON.stringify(error)}`,
    );
