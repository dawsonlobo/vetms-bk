...
exports.getOne = exports.getAll = exports.createUpdate = void 0;
var patients_1 = require("../../../models/patients"); // Import the Patient model
...
var createUpdate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _id, dob, patientData, result, updateFields, calculatedAge, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, , 6]);
                _a = req.body, _id = _a._id, dob = _a.dob, patientData = __rest(_a, ["_id", "dob"]);
                result = void 0;
                ...
                updateFields = __assign({}, patientData);
                delete updateFields.isDeleted; // Ensure we don't unintentionally modify this field
                return [4 /*yield*/, patients_1.PatientModel.findByIdAndUpdate(_id, { $set: updateFields }, { new: true, runValidators: true, strict: true }).lean()];
            case 1:
                result = _b.sent(); // Use lean() to return a plain JavaScript object
                if (!result) {
                    req.apiStatus = {
                        isSuccess: false,
            ...
            case 2:
                ...
                calculatedAge = Math.floor((new Date().getTime() - new Date(dob).getTime()) /
                    (1000 * 60 * 60 * 24 * 365.25));
                return [4 /*yield*/, patients_1.PatientModel.create(__assign(__assign({}, patientData), { dob: dob, age: calculatedAge, isDeleted: false }))];
            case 3:
                result = _b.sent();
                req.apiStatus = {
                    isSuccess: true,
            ...
            case 5:
                error_1 = _b.sent();
                console.error("Error in createOrUpdatePatient:", error_1);
                req.apiStatus = {
                    isSuccess: false,
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(patients_1.PatientModel, filter, projection, options, search, date, fromDate, toDate)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(patients_1.PatientModel, { _id: new mongoose_1.default.Types.ObjectId(id) }, projection)];
            case 1:
                result = _a.sent();
            ...
            case 2:
                error_3 = _a.sent();
                console.error("Error fetching record:", error_3);
                req.apiStatus = {
                    isSuccess: false,
                    error: models_1.ErrorCodes[1002],
                    toastMessage: "Something went wrong. Please try again.",
