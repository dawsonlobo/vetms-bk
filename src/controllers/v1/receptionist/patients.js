    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            patients_1.PatientModel.findByIdAndUpdate(
              _id,
              { $set: updateFields },
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            patients_1.PatientModel.create(
              __assign(__assign({}, patientData), {
                dob: dob,
                age: calculatedAge,
                isDeleted: false,
              }),
