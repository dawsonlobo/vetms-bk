...
exports.getOne = exports.Update = void 0;
...
var Update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, remarks, existingAppointment, status_1, updateFields, updatedAppointment, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, appointments_1.AppointmentModel.findOne({
                        _id: new mongodb_1.ObjectId(_id),
                    })];
            case 1:
                existingAppointment = _a.sent();
                ...
                status_1 = existingAppointment.status;
                updateFields = { remarks: remarks };
                // Only update status if it's "pending", do nothing if it's "cancelled"
                if (status_1 === constant_1.CONSTANTS.APPOINTMENT_STATUS.PENDING) {
                    updateFields.status = constant_1.CONSTANTS.APPOINTMENT_STATUS.COMPLETED;
                }
                else if (status_1 === constant_1.CONSTANTS.APPOINTMENT_STATUS.CANCELLED) {
                ...
                return [4 /*yield*/, appointments_1.AppointmentModel.findByIdAndUpdate(_id, updateFields, { new: true })];
            case 2:
...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, projection, objectId, sanitizedProjection, tableData, followUpObj, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, { _id: objectId, isDeleted: false }, sanitizedProjection)];
            case 1:
            ...
            case 2:
                error_2 = _b.sent();
                console.error("Error in upsertBilling:", error_2);
                req.apiStatus = {
                    isSuccess: false,
                    error: models_1.ErrorCodes[1010],
                    toastMessage: "Something went wrong. Please try again.",
...
function getAll(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _b, projection, _c, filter, _d, options, _e, search, date, fromDate, toDate, sanitizedProjection, sanitizedFilter, _f, totalCount, tableData, error_3;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, aggregation_1.aggregateData)(appointments_1.AppointmentModel, sanitizedFilter, sanitizedProjection, options, search, date, fromDate, toDate)];
                case 1:
