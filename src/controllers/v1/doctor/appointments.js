    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            appointments_1.AppointmentModel.findOne({
        ...
        case 1:
          ...
          if (status_1 === constant_1.CONSTANTS.APPOINTMENT_STATUS.PENDING) {
            updateFields.status =
              constant_1.CONSTANTS.APPOINTMENT_STATUS.COMPLETED;
          } else if (
            status_1 === constant_1.CONSTANTS.APPOINTMENT_STATUS.CANCELLED
          ) {
          ...
          return [
            4 /*yield*/,
            appointments_1.AppointmentModel.findByIdAndUpdate(
              _id,
              updateFields,
              { new: true },
            ),
