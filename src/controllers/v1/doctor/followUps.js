...
function createUpdateFollowUp(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _id, patientId, diagnosis, treatment, prescription, visitDate, rest, doctorId, existingUser, existingPatient, updateFields, updatedFollowUp, newFollowUp, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 7, , 8]);
                    _a = req.body, _id = _a._id, patientId = _a.patientId, diagnosis = _a.diagnosis, treatment = _a.treatment, prescription = _a.prescription, visitDate = _a.visitDate, rest = __rest(_a, ["_id", "patientId", "diagnosis", "treatment", "prescription", "visitDate"]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, patients_1.PatientModel.findOne({
                ...
                case 2:
                    ...
                    updateFields = __assign({ patientId: patientId, doctorId: doctorId, diagnosis: diagnosis, treatment: treatment, prescription: prescription, visitDate: visitDate }, rest);
                    delete updateFields.isDeleted; // Explicitly remove `isDeleted`
                    return [4 /*yield*/, followUps_1.FollowUp.findByIdAndUpdate(_id, updateFields, { new: true })];
                case 3:
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, aggregation_1.aggregateData)(followUps_1.FollowUp, sanitizedFilter, sanitizedProjection, options, search, date, fromDate, toDate)];
                case 1:
...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, projection, objectId, sanitizedProjection, tableData, followUpObj, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                ...
                sanitizedProjection = __assign({}, projection);
                delete sanitizedProjection.isDeleted;
                return [4 /*yield*/, (0, aggregation_1.aggregateData)(followUps_1.FollowUp, { _id: objectId, isDeleted: false }, sanitizedProjection)];
            case 1:
