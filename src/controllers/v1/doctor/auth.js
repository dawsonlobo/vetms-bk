    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error_3 = _b.sent();
                    console.error("Logout error: ".concat(error_3 instanceof Error ? error_3.message : "Unknown error"));
                    req.apiStatus = {
                        isSuccess: false,
                        error: models_1.ErrorCodes[1010],
...
function updateDoctorProfile(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var user, _a, name_1, email, role, isDelete, updateFields_1, updatedDoctor, error_5;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _a = req.body, name_1 = _a.name, email = _a.email, role = _a.role, isDelete = _a.isDelete;
                    if (role) {
                        req.apiStatus = {
                            isSuccess: false,
                            error: models_1.ErrorCodes[1012],
                    ...
                    return [4 /*yield*/, users_1.default.findByIdAndUpdate(user.id, updateFields_1, { new: true, select: "-password -isDelete" })];
                case 1:
                ...
                case 2:
                    error_5 = _c.sent();
                    console.error("Error updating doctor profile: ".concat(error_5.message));
                    // Handle duplicate key (email already exists) error
                    if (error_5.code === 11000 && ((_b = error_5.keyPattern) === null || _b === void 0 ? void 0 : _b.email)) {
                        req.apiStatus = {
                            isSuccess: false,
